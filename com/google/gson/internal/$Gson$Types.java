...
/* 343 */     return resolve(context, contextRawType, toResolve, new HashMap<TypeVariable<?>, Type>());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 502 */         $Gson$Preconditions.checkNotNull(this.typeArguments[t]);
...
/*     */     
/*     */     public int hashCode() {
/* 526 */       return Arrays.hashCode((Object[])this.typeArguments) ^ this.rawType
/* 527 */         .hashCode() ^ 
/* 528 */         $Gson$Types.hashCodeOrZero(this.ownerType);
/*     */     }
/*     */     
/*     */     public String toString() {
/* 532 */       int length = this.typeArguments.length;
/* 533 */       if (length == 0) {
/* 534 */         return $Gson$Types.typeToString(this.rawType);
/*     */       }
/*     */       
/* 537 */       StringBuilder stringBuilder = new StringBuilder(30 * (length + 1));
/* 538 */       stringBuilder.append($Gson$Types.typeToString(this.rawType)).append("<").append($Gson$Types.typeToString(this.typeArguments[0]));
/* 539 */       for (int i = 1; i < length; i++) {
/* 540 */         stringBuilder.append(", ").append($Gson$Types.typeToString(this.typeArguments[i]));
/*     */       }
/* 542 */       return stringBuilder.append(">").toString();
/*     */     }
/*     */   }
/*     */   
...
/* 552 */       this.componentType = $Gson$Types.canonicalize(componentType);
/*     */     }
/*     */     
/*     */     public Type getGenericComponentType() {
/* 556 */       return this.componentType;
/*     */     }
/*     */     
/*     */     public boolean equals(Object o) {
/* 560 */       return (o instanceof GenericArrayType && 
/* 561 */         $Gson$Types.equals(this, (GenericArrayType)o));
/*     */     }
/*     */     
/*     */     public int hashCode() {
/* 565 */       return this.componentType.hashCode();
/*     */     }
/*     */     
/*     */     public String toString() {
/* 569 */       return $Gson$Types.typeToString(this.componentType) + "[]";
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 585 */       $Gson$Preconditions.checkArgument((lowerBounds.length <= 1));
/* 586 */       $Gson$Preconditions.checkArgument((upperBounds.length == 1));
/*     */       
/* 588 */       if (lowerBounds.length == 1) {
/* 589 */         $Gson$Preconditions.checkNotNull(lowerBounds[0]);
/* 590 */         $Gson$Types.checkNotPrimitive(lowerBounds[0]);
/* 591 */         $Gson$Preconditions.checkArgument((upperBounds[0] == Object.class));
/* 592 */         this.lowerBound = $Gson$Types.canonicalize(lowerBounds[0]);
/* 593 */         this.upperBound = Object.class;
/*     */       } else {
/*     */         
/* 596 */         $Gson$Preconditions.checkNotNull(upperBounds[0]);
/* 597 */         $Gson$Types.checkNotPrimitive(upperBounds[0]);
/* 598 */         this.lowerBound = null;
/* 599 */         this.upperBound = $Gson$Types.canonicalize(upperBounds[0]);
/*     */       } 
/*     */     }
/*     */     
/*     */     public Type[] getUpperBounds() {
/* 604 */       return new Type[] { this.upperBound };
/*     */     }
/*     */     
/*     */     public Type[] getLowerBounds() {
/* 608 */       (new Type[1])[0] = this.lowerBound; return (this.lowerBound != null) ? new Type[1] : $Gson$Types.EMPTY_TYPE_ARRAY;
/*     */     }
/*     */     
/*     */     public boolean equals(Object other) {
/* 612 */       return (other instanceof WildcardType && 
/* 613 */         $Gson$Types.equals(this, (WildcardType)other));
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
/* 618 */       return ((this.lowerBound != null) ? (31 + this.lowerBound.hashCode()) : 1) ^ 31 + this.upperBound
/* 619 */         .hashCode();
/*     */     }
/*     */     
/*     */     public String toString() {
/* 623 */       if (this.lowerBound != null)
/* 624 */         return "? super " + $Gson$Types.typeToString(this.lowerBound); 
/* 625 */       if (this.upperBound == Object.class) {
/* 626 */         return "?";
/*     */       }
/* 628 */       return "? extends " + $Gson$Types.typeToString(this.upperBound);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\cat\Desktop\ReviversTwo-PUBLIC.jar!\com\google\gson\internal\$Gson$Types.class
